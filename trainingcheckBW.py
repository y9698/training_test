...
# model.save(r"my_model3.h5")
#-+del model

model = load_model(r"my_modelBK1.h5")
...
print("true;",Ans(y_test[testx]))

img = np.squeeze(x_test[testx]) #sqeeze 28,28,1 -->28,28
